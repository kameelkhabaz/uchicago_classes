...
def go():
    ...
    print("Rodents, Garbage => Crime", linear_regression(
       prepend_ones_column(city_data[:,2:4]), city_data[:,7]))
    print()
    print()
    ...
    print("Task 4")
    ### REPLACE 0.0 with appropriate call to linear regression
    print("Graffiti => Crime:", linear_regression(
       prepend_ones_column(city_data[:,0].reshape(-1,1)), city_data[:,7]))
    print()
    print()
